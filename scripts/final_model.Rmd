...
Scale any numerical columns, except lat/long and use/nonuse. This would involve elevation, distance to water, distance to roads, and canopy cover. Would need to determine column numbers. Scaling would help standardize the numerical covariates --> allows us to compare each coefficient to each other.
...
model.set <- list(mod1, mod2, mod3, etc)
model.names <- c("mod1", "mod2", "mod3", "etc.")
